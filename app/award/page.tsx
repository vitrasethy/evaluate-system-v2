    ...
    <main className="bg-[#070707]">
      <section className="first-screen">
        ...
        <div className="text-center h-[85vh] flex flex-col justify-center items-center">
          <h1
            className="text-4xl tracking-tight font-extrabold font-['Georgia'] uppercase sm:text-5xl md:text-8xl bg-gradient-to-r from-[#3b7cc1] to-[#9ae2ff] inline-block text-transparent bg-clip-text drop-shadow-[7px_5px_rgba(205,245,253,0.2)]">
      ...
      <section className="second-screen">
        ...
        <div className=" h-screen flex justify-center items-center">
          <div
            className="flex justify-center w-[53%] gap-8 items-center bg-[url('/reward3.jpeg')] bg-no-repeat bg-cover border-2 border-gray-500">
            <div className=" rounded-md bg-sky-950/30 backdrop-brightness-[.6] w-full p-8">
              ...
              <div className="relative w-auto">
                <div
                  className="bg-gradient-to-r from-[#cc9910] to-[#fcf97c] shadow-lg border-1 py-6 px-10 rounded-full">
              ...
              <div className="relative mt-8">
                <div
                  className="bg-gradient-to-r from-[#C0C0C0] to-[#e9e9eb] shadow-lg border-1 py-6 px-10 rounded-full">
                  <div className="flex gap-8 text-3xl">
                    <p>2nd</p>
                    {isRunning && (
                      <div className="flex gap-8">
              ...
              <div className="relative mt-8">
                <div
                  className="bg-gradient-to-r from-[#ca6533] to-[#F0C9BA] shadow-lg border-1 py-6 px-10 rounded-full">
                  <div className="flex gap-8 text-3xl">
                    <p>2nd</p>
                    {isRunning2 && (
                      <div className="flex gap-8">
